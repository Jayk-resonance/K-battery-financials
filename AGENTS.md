...
| 4 | `schema/market_company_data.md` | **시장·회사 정량 데이터 작업 시** 지역·Application·판매량·생산능력·출처 규칙 |
| 5 | `schema/earnings_template.md` | **실적·컨콜 전용** staging JSON·표준 MD·출처 규칙 |
| 6 | `README.md` | 저장소 설계 배경 |
